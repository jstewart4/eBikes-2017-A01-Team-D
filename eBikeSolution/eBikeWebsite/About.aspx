...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h4><img src="mike.jpg" alt="mike's logo" height="100" width="80"> &nbsp;&nbsp;Mike Bateman - Sales </h4>
    <hr>

    <h4> <img src="igor.jpg" alt="igor's logo" height="100" width="80"> &nbsp;&nbsp;Igor Marchenko - Receiving </h4>
    <hr />

    <h4><img src="jamie.jpg" alt="jamie's logo" height="100" width="80"> &nbsp;&nbsp;Jamie Stewart - Purchasing</h4>
    <hr />
            
       
    <h4><img src="vadim.jpg" alt="vadim's logo" height="100" width="80"> &nbsp;&nbsp;Vadim Goutsouk - Jobing</h4>
      <br />
