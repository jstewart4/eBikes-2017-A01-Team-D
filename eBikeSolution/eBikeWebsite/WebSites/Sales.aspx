...
<style>
    ...
    <div class="row">
        <div class="col-md-3 well">
            ...
            <h3><asp:Label ID="CategoryListLabel" runat="server" Text="Browse by Category"></asp:Label></h3><br />
        ...
        <div class="col-md-8 well">
            <div class="form-group">
            <h3><asp:Label ID="PartsListLabel" runat="server" Text="Products"></asp:Label></h3><br />
